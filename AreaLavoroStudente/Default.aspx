                        ...
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="#">Modifica account</a></li>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="#">materiali</a></li>
                                    <li><a class="dropdown-item" href="#">lezioni</a></li>
                                    <li><a class="dropdown-item" href="#">appelli</a></li>
                                    <li><a class="dropdown-item" href="#">test</a></li>
                                </ul>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="#">Valutazione degli esami</a>
                            </li>

                        </ul>
                        <ul class="navbar-nav navbar-right">
                            <li class="nav-item">
                                <a class="btn btn-light btn-sm disabled"><i class="bi bi-person-circle"></i> *Placeholder per il nome docente*</a>
                            </li>
        ...
        <div class="bg-dark text-white position-sticky">
            <div class="container d-flex justify-content-between align-items-end flex-wrap">
                <div>
                    ...
                    <p class="fs-4 ms-4 mb-0">Università UNIGen</p>
