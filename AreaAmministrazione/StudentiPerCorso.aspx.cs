...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void CaricaChar()
    {
        ...
        Chart1.ChartAreas["ChartArea1"].AxisX.Title = "Corsi";
        ...
        if (annoscelto == "0")
        {
            dt = s.SelezionaPerCorso();
        }
        else
        {
            dt = s.SelezionaPerCorsoAnnoSingolo(annoscelto);
        }

        if (dt != null && dt.Rows.Count > 0)
        {
            Chart1.DataSource = dt;
            Chart1.Series["Series1"].XValueMember = "TitoloCorso";
