<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="StudentiPerFacolta.aspx.cs" Inherits="_Default" %>

<%@ Register Assembly="System.Web.DataVisualization, Version=4.0.0.0, Culture=neutral, PublicKeyToken=31bf3856ad364e35" Namespace="System.Web.UI.DataVisualization.Charting" TagPrefix="asp" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        <h1 class="ms-5 mb-5"> Studenti Iscritti per Facoltà</h1>
        ...
        <div class="border p-5 rounded shadow w-75">
            ...
            <%--<div class="text-center">
                <asp:Button
                    ID="btnAnnoCorrente"
                    runat="server"
                    Text="Mostra Anno Corrente"
                    CssClass="btn btn-primary px-5 py-2"
                    OnClick="btnAnnoCorrente_Click"
