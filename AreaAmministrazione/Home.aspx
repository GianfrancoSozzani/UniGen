    ...
    <div class="layout-wrapper">
        ...
        <main class="main-content">
            ...
            <div class="mt-5">
                <h3>Azioni rapide</h3>
                <div class="btn-group">
                    <a class="btn btn-outline-primary" href="Gestione_Corsi.aspx?r=<%=Request.QueryString["r"]%>&cod=<%=Request.QueryString["cod"]%>&usr=<%=Request.QueryString["usr"]%>"><i class="bi bi-plus-circle me-1"></i>Nuovo corso</a>
                    <a class="btn btn-outline-info" href="AbilitaStudente.aspx?r=<%=Request.QueryString["r"]%>&cod=<%=Request.QueryString["cod"]%>&usr=<%=Request.QueryString["usr"]%>"><i class="bi bi-person-plus me-1"></i>Nuovo studente</a>
                    <a class="btn btn-outline-success" href="IncassoAnnuale.aspx?r=<%=Request.QueryString["r"]%>&cod=<%=Request.QueryString["cod"]%>&usr=<%=Request.QueryString["usr"]%>"><i class="bi bi-file-earmark-arrow-down me-1"></i>Incasso Annuale</a>
                </div>
            </div>
